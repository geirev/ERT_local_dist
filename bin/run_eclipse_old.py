...
version_table = {"2009.2"     : ("/ecl/2009.2/bin/linux_x86_64/eclipse.exe"     , "/ecl/2009.2/bin/linux_x86_64/eclipse_scampi.exe"),
                 "2010.2"     : ("/ecl/2010.2/bin/linux_x86_64/eclipse.exe"     , "/ecl/2010.2/bin/linux_x86_64/eclipse_scampi.exe"),
                 "2016.1"     : ("/ecl/2016.1/bin/linux_x86_64/eclipse.exe"     , "/ecl/2016.1/bin/linux_x86_64/eclipse_scampi.exe")}
...
env_variables = {"F_UFMTENDIAN"    : "big",
                 "LM_LICENSE_FILE" : "/ecl/macros/license.lic" }
...
def exec_single(executable , args , env_variables):
    os.execve(executable , [ executable ] + args , env_variables)
...
init_fd( base_name )
if num_cpu == 1:
    exec_single( executable, [ base_name ] , env_variables)
else:
